          ...
          <div className="bg-white rounded-[3rem] w-full max-w-2xl shadow-2xl overflow-hidden relative flex flex-col max-h-[85vh] border border-white/20">
            <div className="px-8 py-8 border-b border-gray-100 flex items-center justify-between shrink-0 bg-gray-50/50">
               <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-xl font-black text-[#004A74] uppercase tracking-tight truncate max-w-md">Book Detail</h3>
                    <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Personal Archive Asset</p>
                  </div>
               </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-8 md:p-10 space-y-8">
               ...
               <div className="p-6 bg-gray-50 rounded-3xl border border-gray-100 space-y-4">
                  <div className="flex items-center gap-2 text-[10px] font-black text-[#004A74] uppercase tracking-[0.2em]">
                     <FileText className="w-4 h-4" /> Reference Info
                  </div>
               ...
               <div className="flex flex-col gap-2 pt-4 border-t border-gray-50">
                  ...
                  {detailItem.isbn && (
                    <div className="flex items-center gap-2 text-xs font-bold text-gray-400">
                       ...
                       <span className="font-mono text-[11px] text-[#004A74] opacity-70">{detailItem.isbn}</span>
                    </div>
                  )}
               </div>
            </div>
            ...
            <div className="px-10 py-8 border-t border-gray-100 flex items-center justify-between gap-3 bg-gray-50/30">
               ...
               <div className="flex items-center gap-3">
                  ...
                  <button onClick={() => setDetailItem(null)} className="px-8 py-4 bg-[#004A74] text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl">Dismiss</button>
               </div>
            </div>
          </div>
        </div>
