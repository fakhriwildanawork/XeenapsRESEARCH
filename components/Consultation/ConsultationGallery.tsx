            ...
            {items.map((item) => {
              ...
              return (
                <div 
                  ...
                  className={`group relative bg-white border border-gray-100 rounded-3xl p-5 flex items-center gap-4 shadow-sm hover:shadow-md hover:border-[#004A74]/20 transition-all duration-300 cursor-pointer ${isSelected ? 'ring-2 ring-[#004A74] bg-blue-50/30' : ''}`}
                >
                  {/* LEFT: CHECKBOX */}
                  <div 
